...
start_dates = {
    "Beta": datetime(2025, 4, 25, 10, 0),     # 28 ส.ค. 2024 10:00
...
release_after_beta_days = 42     # ระยะห่าง Release หลัง Beta (ถ้าต่างจาก beta_interval_days)
...
for ver, dates in version_dates.items():
    ...
    markdown_lines.append(f"Zenless Zone Zero {ver}")
