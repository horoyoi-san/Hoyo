...
# URLs ที่จะตรวจสอบ
url_1 = "https://sg-hyp-api.hoyoverse.com/hyp/hyp-connect/api/getGamePackages?game_ids%5B%5D=wkE5P5WsIf&launcher_id=VYTpXlbWo8"
url_2 = "https://sg-hyp-api.hoyoverse.com/hyp/hyp-connect/api/getGamePackages?game_ids%5B%5D=5TIVvvcwtM&launcher_id=VYTpXlbWo8"
url_3 = "https://sg-hyp-api.hoyoverse.com/hyp/hyp-connect/api/getGamePackages?game_ids%5B%5D=g0mMIvshDb&launcher_id=VYTpXlbWo8"
url_4 = "https://sg-hyp-api.hoyoverse.com/hyp/hyp-connect/api/getGamePackages?game_ids%5B%5D=uxB4MC7nzC&launcher_id=VYTpXlbWo8"
url_5 = "https://sg-hyp-api.hoyoverse.com/hyp/hyp-connect/api/getGamePackages?game_ids%5B%5D=bxPTXSET5t&launcher_id=VYTpXlbWo8"
    ...
    for name, webhook_url in webhook_urls.items():
        try:
            ...
            for chunk in chunks:
                ...
                if len(chunk) <= 6000:
                    embeds.append({
                        "title": f"{name} - Honai Impact 3 OS PROD {source}" if len(embeds) == 0 else None,
                        "description": f"```json\n{chunk}\n```",
                        "color": 0x00ecff,
                        "footer": {
