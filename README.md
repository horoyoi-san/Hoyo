...
| - | - | - |
| Zenless Zone Zero |Version|Sophon.Downloader.exe full U5hbdsT9W7 game Version output --region=OSREL |
| Zenless Zone Zero |Version|Sophon.Downloader.exe full x6znKlJ0xK game Version output --region=CNREL |
