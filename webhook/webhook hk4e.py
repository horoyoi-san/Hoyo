...
CHANNEL_ID = os.getenv("DISCORD_HK4E_CHANNEL_ID", os.getenv("DISCORD_CHANNEL_ID", "YOUR_CHANNEL_ID"))
...
def send_discord_message(payload):
    ...
    raise RuntimeError(
        "Please set DISCORD_WEBHOOK_URL or set DISCORD_BOT_TOKEN and DISCORD_HK4E_CHANNEL_ID."
    )
