...
API_URL = "https://sg-hyp-api.hoyoverse.com/hyp/hyp-connect/api/getGameBranches?game_ids[]=4ziysqXOQ8&launcher_id=VYTpXlbWo8"
...
def check_branch():
    ...
    game_data = next(g for g in game_info["data"]["games"] if g["id"] == "4ziysqXOQ8")
