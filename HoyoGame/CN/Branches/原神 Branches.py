...
# ================= Branding =================
BOT_NAME = "原神 Branches"
BOT_ICON = "https://raw.githubusercontent.com/horoyoi-san/Hoyo/refs/heads/Webhook/assets/hk4e_cn.png"
...
try:
    if has_changed(BRANCH_API_URL, f"{GAME_NAME}"):
        ...
        print("[GI_BRANCH] No change, skipping webhook")
