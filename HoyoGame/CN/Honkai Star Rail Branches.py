...
API_URL = "https://hyp-api.mihoyo.com/hyp/hyp-connect/api/getGameBranches?game_ids[]=64kMb5iAWu&launcher_id=jGHBHlcOq1"
...
def check_branch():
    ...
    game_data = next(g for g in game_info["data"]["games"] if g["id"] == "64kMb5iAWu")
