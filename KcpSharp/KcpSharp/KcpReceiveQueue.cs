...
using LinkedListOfQueueItem =
    System.Collections.Generic.LinkedList<(March7thHoney.Kcp.KcpSharp.KcpBuffer Data, byte Fragment)>;
using LinkedListNodeOfQueueItem =
    System.Collections.Generic.LinkedListNode<(March7thHoney.Kcp.KcpSharp.KcpBuffer Data, byte Fragment
        )>;
#endif
