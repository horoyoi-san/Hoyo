...
export default function StartPage({setLauncherId, appState, setState}: {setLauncherId: (id: string) => void, appState: number, setState: (state: number) => void}) {
	...
	return (
		<Container>
			<span className="text-white/60">Please enter the launcher id, the default one is &quot;<span className="text-white/95 select-all">jGHBHlcOq1</span>&quot; but you can use another one if you want.</span>
