...
api_urls = [
    "https://gist.githubusercontent.com/horoyoi-san/b36a0566171c979b836531dd1224bb10/raw/7a149c7e45129c87f2f978ee252b7fbf0dae75a4/index.json",
...
def send_embed_message(webhook_url, title, description):
    embed = {
        "embeds": [{
            ...
            "color": 16753920,
            "thumbnail": {
                "url": "https://fastcdn.hoyoverse.com/static-resource-v2/2025/08/28/f8162b4e119b78cd7a67ef5c64b830c6_9217397143028229513.png"
            },
            "image": {
                "url": "https://fastcdn.hoyoverse.com/content-v2/plat/159055/741c727c224dd776dc49a1d479d687a3_6201236413998705058.jpeg"
            },
            "footer": {
                "text": "Honkai Nexus Anima Update Monitor",
...
for index, api_url in enumerate(api_urls, start=1):
    try:
        ...
        game_data.append(("Honkai Nexus Anima ", combined_main))
        ...
        for patch in game_package["main"].get("patches", []):
            ...
            game_data.append((f"Honkai Nexus Anima  {patch_version} - Hdiff", combined_patch))
        ...
        if pre_major:
            ...
            game_data.append(("Honkai Nexus Anima Pre-Download", combined_pre))
        ...
        for patch in pre.get("patches", []):
            ...
            game_data.append((f"Honkai Nexus Anima Pre-Download {patch_version} - Hdiff", combined_pre_patch))
